...
namespace BusinessObjects
{
	...
	abstract public partial class tgDrugbankdruginteraction : tgEntity
	{
		...
		{
			DrugbankdruginteractionQuery query = new DrugbankdruginteractionQuery("a7");
		...
		public DrugbankdruginteractionQuery Query
		{
			get
			{
				if (this.query == null)
				{
					this.query = new DrugbankdruginteractionQuery("b7");
	...
	abstract public partial class tgDrugbankdruginteractionCollection : tgEntityCollection<Drugbankdruginteraction>
	{
		...
		public DrugbankdruginteractionQuery Query
		{
			get
			{
				if (this.query == null)
				{
					this.query = new DrugbankdruginteractionQuery("c7");
					InitQuery(this.query);
				}
		...
		override protected tgDynamicQuery GetDynamicQuery()
		{
			if (this.query == null)
			{
				this.query = new DrugbankdruginteractionQuery("d7");
